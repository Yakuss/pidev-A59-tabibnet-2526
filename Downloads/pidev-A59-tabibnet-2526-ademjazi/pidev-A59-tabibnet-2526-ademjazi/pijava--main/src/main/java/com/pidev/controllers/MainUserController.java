...
public class MainUserController {
    ...
    @FXML private Button btnForum, btnProfile, btnHome, btnMedecins, btnAnnuaire, btnAppointments, btnMagazines;
    ...
    public void showMagazines() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/MagazinePatientView.fxml"));
            ...
            System.err.println("❌ Error loading MagazinePatientView: " + e.getMessage());
        }
    }
