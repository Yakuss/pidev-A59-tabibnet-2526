...
public class DashboardController {
    ...
    @FXML private Button btnDashboard, btnPatients, btnMedecins, btnAppointments, btnFeedback, btnForum, btnSpecialites, btnMagazines, btnSettings, btnLogout;
    ...
    public void showMagazines() {
        setActiveButton(btnMagazines);
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/MagazineAdminView.fxml"));
            ...
            System.err.println("❌ Error loading MagazineAdminView: " + e.getMessage());
        }
    }
